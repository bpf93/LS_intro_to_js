...
//What do the following error message and stack trace tell you? (above)

/*
My answer:
filename is exercise2.js
The issue started at line 4, column 15 of the file.
There's a reference error: the variable greeting is not defined.
