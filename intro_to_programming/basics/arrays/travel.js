...
For example: When checking whether 'Barcelona' is 
contained in destinations, the expected output is 
true, whereas the expected output for 'Nashville' is false.
...
/*
I want to check to see if a given destination (input)
is a part of the destinations array.
*/
